...
window.addEventListener("load", function() {
  (function($) {
    ...
    ShoppingCart.prototype.flyImageToCart = function() {
      var wrapper = $("#js-fly-image-to-cart-box"),
        imgToDrag = wrapper.find("img").eq(0),
        top       = (wrapper.offset().top + wrapper.outerHeight()/2) - 75,
        left      = (wrapper.offset().left + wrapper.outerWidth()/2) - 75,
