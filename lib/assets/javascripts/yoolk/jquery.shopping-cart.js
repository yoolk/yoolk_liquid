...
window.onload = function() {
  (function($) {
    ...
    ShoppingCart.prototype.bindClickAddToCart = function() {
      ...
      this.$element.find('.js-add-to-cart').each(function() { 
        $(this).click(function() {
          ...
          if(self.validatePositiveNumber(qty)) {
    ...
    ShoppingCart.prototype.validatePositiveNumber = function(val) {
      var pattern = /^\d+$/;
    ...
    ShoppingCart.prototype.buildSubtotalLi = function() {
      var totalCost = this.getTotal(),
          ...
          $btnCheckout = $('<a href="#" class="btn btn-checkout">').text(this.locales.checkout);
