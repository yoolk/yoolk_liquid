module Yoolk
  module Liquid
    class ListingDrop < BaseDrop
      ...
      # belongs_to  :telephone,             class_name: 'Yoolk::Liquid::Liquid::CommunicationDrop'
      # belongs_to  :email,                 class_name: 'Yoolk::Liquid::Liquid::CommunicationDrop'
      # belongs_to  :website,               class_name: 'Yoolk::Liquid::Liquid::CommunicationDrop'
