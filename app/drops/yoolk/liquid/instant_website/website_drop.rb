  ...
  module Liquid
    module InstantWebsite
      class WebsiteDrop < BaseDrop
        attributes  :id, :google_analytics_key, :owner_google_analytics_key, :is_live, 
                    :is_active, :free_plan, :template_name, :color, :primary_domain, 
                    :google_webmaster_tag, :created_at, :updated_at
