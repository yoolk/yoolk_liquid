...
module Yoolk
  module Sandbox
    describe InstantWebsite::Website do
      ...
      it 'has :custom_pages attribute' do
        expect(described_class).to have_attribute(:custom_pages).of_type(Array, member_type: Yoolk::Sandbox::InstantWebsite::CustomPage)
      end
